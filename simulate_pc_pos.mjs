// Simulador POS vs PC con servidor Render-side
// Ejecutar con: node simulate_pc_pos.mjs
...
async function run() {
  try {
    ...
    resp = await fetch(`${PC_API_URL}/api/pc/pair`, {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ pc_id: PC_ID, pc_name: PC_ID })
    });
