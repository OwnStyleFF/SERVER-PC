...
async function main() {
  ...
  assert(foundA.pc_name === nameA, `pcA name mismatch expected ${nameA} got ${foundA.pc_name}`);
  assert(foundB.pc_name === `${nameB}-nuevo`, `pcB name mismatch expected ${nameB}-nuevo got ${foundB.pc_name}`);
